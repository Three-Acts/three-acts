...
-- Generated 2026-09-25T06:37:03.376Z by npm run schema:diff / schema:migrate -w @three-acts/api.
...
alter table "product_catalog" add column if not exists "demo_video" text;
