...
import { columnHeaderClass, focusRing, PanelHeader, ScrollArea, StatusDot } from "../../atoms";
...
/** Left pane: the predefined static pages, identified by name. */
export function PageList({ isLoading, onSelect, pages, selectedId, showStatus, title }: PageListProps) {
  return (
