...
const redirectInputs: RedirectInput[] = [
  ...
  { source: "blogs/news/how-to-brew-v60", target: "/blog/how-to-brew-a-better-v60", hits: 7_604, notes: "Top organic landing page on the old blog — keep permanently." },
  { source: "blogs/news/aeropress-recipe-competition", target: "/blog/aeropress-recipes-we-keep-coming-back-to", hits: 1_322 },
  { source: "blogs/news/meet-our-farmers-huye", target: "/blog/visiting-huye-mountain-rwanda", hits: 640 },
  { source: "blogs/news/grinder-buying-guide", target: "/blog/choosing-a-hand-grinder", hits: 2_987 },
  { source: "blogs/news/we-are-moving", target: "/blog/our-new-home-in-observatory", hits: 415 },
...
const messages: Record<Source, string[]> = {
  ...
  support: [
    ...
    "The discount code FIRSTROAST isn't working at checkout.",
